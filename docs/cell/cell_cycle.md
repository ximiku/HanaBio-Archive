...
被许可的潜在起点多于正常条件下实际启动的起点，其中一部分可在邻近复制叉受阻时作为备用起点。复制是否完成取决于所有复制叉的推进与终止，不能由一个单一的“SPF”浓度读出。这里关注许可与周期的接口；起点选择、复制叉组成、领先链／后随链合成及终止机制见[DNA复制与逆转录](../molecular/dna_replication.md)。
