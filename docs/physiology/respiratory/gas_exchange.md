...
## 肺泡—毛细血管屏障的扩散通量 { #alveolar-capillary-diffusion }

### 菲克扩散中的面积、距离与气体性质 { #fick-diffusion }
...
### 气体交换的弥散与灌流限制 { #diffusion-perfusion-limitation }
...
低 V/Q 血液造成的低氧难以由高 V/Q 单位补偿，主要因为高 V/Q 单位的血红蛋白已处于氧解离曲线平台，再提高 $P_{\mathrm O_2}$ 只增加很少的结合氧；CO$_2$ 含量—分压关系和总体通气调节则提供了更大的代偿余量。所以局部 V/Q 不均最常见的后果是低氧血症和通气功增加，只有整体有效通气不足、代偿失败或病变广泛时，$P_{a\mathrm{CO}_2}$ 才明显升高。[^vq-relationships]
...
## 分流、静脉掺杂与动脉氧分压 { #shunt-venous-admixture }
...
系统毛细血管内，O$_2$ 依次从红细胞释放到血浆、跨内皮进入间质，再沿组织分压梯度向细胞和线粒体扩散；CO$_2$ 的净通量方向相反。扩散距离、毛细血管密度、血流异质性和细胞耗氧共同塑造局部分压场。肌红蛋白在横纹肌细胞内持续缓冲结合氧，并参与细胞内氧扩散。

## 二氧化碳运输的氧合耦联 { #carbon-dioxide-transport }

### 二氧化碳的运输形式 { #carbon-dioxide-forms }
...
血液总 CO$_2$ 含量随 $P_{\mathrm{CO}_2}$ 上升而增加，在常见生理范围内比氧解离曲线更接近线性，但“近似线性”不等于永无容量边界。去氧血的 CO$_2$ 解离曲线位于同分压氧合血之上，正是 Haldane 效应在整血尺度的表现。碳酸酐酶抑制剂会改变这一快速转化；其药理、适应证与酸碱后果需要结合药物作用和全身酸碱状态判断。

## 呼吸性 CO$_2$ 调节与酸碱稳态 { #respiratory-acid-base }
...
[^cyanosis]: NCBI Bookshelf, [Cyanosis](https://www.ncbi.nlm.nih.gov/books/NBK367/)。经典的 5 g/dL 去氧血红蛋白可见阈值尚未被精密方法严格确证，只能作为历史近似而非诊断常数。
