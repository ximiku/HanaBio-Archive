...
糖原是动物、真菌和许多细菌储存葡萄糖的分支多糖。在哺乳动物细胞中，它以结合糖原合酶、磷酸化酶、分支酶、去分支酶和调节蛋白的动态颗粒存在。进食、禁食、运动或应激会改变葡萄糖进入、糖链延伸、分支重塑、末端磷酸解和产物去向之间的净通量。[^glycogen-overview]

## 糖原颗粒的分支结构与动态周转 { #granule-architecture }
...
把许多葡萄糖残基连接为一个大分子，能显著减少具有渗透活性的独立粒子数；适度而有规则的分支又提高水合与可溶性，并让多组酶同时接近不同非还原端。链长与分支密度存在适宜范围，共同决定颗粒的可溶性、紧密程度与动员速度。糖原颗粒还可按大小和亚细胞位置形成不同群体，因此总糖原量只描述这些局部储库的一项总体性质。[^granule-dynamics]

## 肝糖原与肌糖原的组织分工 { #tissue-fates }

肝糖原主要在餐后储存来自门静脉和肝内碳流的葡萄糖，在吸收后期与短期禁食中参与缓冲血糖。肝细胞把糖原产生的葡萄糖-6-磷酸（glucose 6-phosphate，G6P）送入内质网的葡萄糖-6-磷酸酶（glucose 6-phosphatase，G6Pase）系统，生成游离葡萄糖并输出；这一终末步骤与[糖异生](gng.md#g6pase-bypass)共用。肝糖原分解和糖异生的相对贡献随禁食时间连续变化，并存在较长的重叠阶段。

骨骼肌缺少足以承担血糖输出的 G6Pase 系统，所以肌糖原产生的 G6P主要留在细胞内，经[糖酵解](emp.md)支持收缩或进入其他支路。糖原来源的 G6P又已经越过己糖激酶步骤，适合快速供给高通量糖酵解。肝糖原由血糖稳态优先调用，肌糖原则服务局部能量需求；二者使用相似的反应化学，却依靠组织同工酶、受体和调节蛋白形成不同的生理输出。肝—肌分工概括了两个主要糖原库，其他组织还具有服务局部功能的小型糖原池。[^tissue-specialization]

## 糖原合成 { #glycogen-synthesis }

### 糖磷酸互变与 UDP-葡萄糖活化 { #udp-glucose-activation }

进入糖原合成的葡萄糖通常先成为 G6P。磷酸葡萄糖变位酶 1（phosphoglucomutase 1，PGM1）借磷酸化丝氨酸与葡萄糖-1,6-二磷酸中间体，催化 G6P 与葡萄糖-1-磷酸（glucose 1-phosphate，G1P）互变。随后 UDP-葡萄糖焦磷酸化酶 2（UDP-glucose pyrophosphorylase 2，UGP2）以尿苷三磷酸（uridine triphosphate，UTP）生成尿苷二磷酸葡萄糖（uridine diphosphate glucose，UDP-葡萄糖）和无机焦磷酸（inorganic pyrophosphate，PP$_i$）：

$$
\mathrm{G1P+UTP\rightleftharpoons UDP\!\text{-}glucose+PP_i}.
$$

焦磷酸酶继续水解 PP$_i$，在细胞条件下把净反应推向 UDP-葡萄糖生成。UDP-葡萄糖的异头碳已被核苷二磷酸离去基团活化，因而能把葡糖基转给正在延长的糖链；这一活化位置也标明了糖原合成中能量的进入点。[^udp-glucose]

### 糖原素介导的经典引发及其替代机制 { #glycogenin-priming }

在经典模型中，糖原素（glycogenin）先把 UDP-葡萄糖的葡糖基共价转移到自身酪氨酸（tyrosine，Tyr）残基，再自糖基化形成一段短 $\alpha(1\rightarrow4)$ 葡聚糖；糖原合酶随后接手延长。糖原素由此为许多颗粒提供经典共价引发位点，并与糖原合酶相互作用；颗粒数量和糖原合酶活性还受其他装配因素影响。[^glycogenin-classic]

人类双等位 *GYG1* 缺陷的肌肉仍可形成大量糖原和多聚葡聚糖，糖原素缺失小鼠也能合成糖原。这些观察提示体内还存在替代引发机制；糖原素继续承担重要的颗粒组织与质量控制功能。糖原素数量、颗粒数量与替代引发底物之间的关系尚待阐明。[^glycogenin-dispensable]

### 糖链延长与分支形成 { #elongation-branching }

糖原合酶把 UDP-葡萄糖的葡糖基转移到既有葡聚糖的非还原端，形成新的 $\alpha(1\rightarrow4)$ 键并释放尿苷二磷酸（uridine diphosphate，UDP）。糖原合酶 1（glycogen synthase 1，GYS1）是多数组织的同工酶，在骨骼肌等组织中承担主要合成反应；糖原合酶 2（glycogen synthase 2，GYS2）则是肝脏主要同工酶。糖原分支酶 1（glycogen branching enzyme 1，GBE1）从足够长的链上切取末端链段，常为约 6–8 个残基，把它的还原端连接到同一颗粒另一位置的 C6 羟基，生成 $\alpha(1\rightarrow6)$ 分支。[^synthase-branching]
...
GBE1 进行链内转糖基作用，无须为每个分支另加腺苷三磷酸（adenosine triphosphate，ATP）。分支酶转移较长链段以建立结构；去分支酶则在分解受阻时先移动三个残基，再水解暴露的单个分支葡萄糖。

## 糖原分解 { #glycogen-breakdown }

### 胞质糖原磷酸解 { #cytosolic-glycogenolysis }

#### 糖原磷酸化酶与 G1P 释放 { #glycogen-phosphorylase }

糖原磷酸化酶以无机磷酸（inorganic phosphate，P$_i$）而不是水进攻外周的 $\alpha(1\rightarrow4)$ 键：
...
产物已经带有磷酸基，因而分解保留了一部分糖苷键的化学势。酶结合的磷酸吡哆醛（pyridoxal 5′-phosphate，PLP）参与酸碱催化；这里使用的是 PLP 的磷酸基功能，而不是它在转氨反应中常见的醛基—亚胺电子汇化学。PLP 的反应多样性见[维生素与辅酶](vitamin_and_coenzyme.md#pyridoxal-phosphate)。[^phosphorylase-mechanism]
...
#### 去分支反应与 G1P／G6P 转换 { #debranching-and-pgm }

一个糖原去分支酶（glycogen debranching enzyme，AGL）多肽具有两种催化活性。4-$\alpha$-葡聚糖转移酶先把分支末端三个 $\alpha(1\rightarrow4)$ 连接的残基移到邻近非还原端，只在分支点留下一个葡萄糖；随后淀粉-$\alpha$-1,6-葡糖苷酶以水解切开该 $\alpha(1\rightarrow6)$ 键，释放游离葡萄糖。前一步属于转糖基，只有后一步属于水解。[^debranching]
...
### 溶酶体糖原周转 { #lysosomal-turnover }

部分胞质糖原可经自噬相关过程送入溶酶体，由酸性 $\alpha$-葡糖苷酶（acid $\alpha$-glucosidase，GAA）在酸性腔内水解 $\alpha(1\rightarrow4)$ 与 $\alpha(1\rightarrow6)$ 键，产物主要是游离葡萄糖。这条路线不使用胞质糖原磷酸化酶—AGL 反应链，其相对贡献随组织、发育和代谢状态改变。GAA 缺陷造成 Pompe 病（糖原贮积病 II 型）：溶酶体糖原持续积累，尤其损害心肌、骨骼肌和呼吸相关肌群。[^lysosomal-glycogen]

糖原分解除胞质磷酸解外，还包括溶酶体内由 GAA 完成的水解；Pompe 病定位于后一通路。溶酶体膨大、糖原结构异常和可利用 G6P 不足分别对应不同缺陷层次。

## 糖原代谢的能量计量 { #energy-accounting }

从游离葡萄糖合成一个糖原残基时，己糖激酶（hexokinase，HK）或葡萄糖激酶（glucokinase，GCK）生成 G6P 消耗 1 ATP，UGP2 步骤又消耗 1 UTP；UDP 通常由核苷二磷酸激酶借 ATP 再生成 UTP。因此从游离葡萄糖起算，常说需要两个核苷三磷酸高能键当量；若起点本来就是 G6P，则只计算 UDP-葡萄糖活化所需的 UTP 当量。分支酶本身不再消耗 ATP 或 UTP。[^glycogen-energy]
...
## 糖原代谢调节 { #reciprocal-regulation }

### 共价修饰与变构调节 { #covalent-regulation }

糖原合酶受到多位点磷酸化。总体上，去磷酸化形式活性较高，糖原合酶激酶 3（glycogen synthase kinase 3，GSK3）、蛋白激酶 A（protein kinase A，PKA）等激酶的某些磷酸化作用降低活性；但磷酸化酶并非必然完全关闭，G6P 还能变构激活糖原合酶，并促进其成为磷酸酶底物。糖原磷酸化酶在磷酸化酶激酶作用下由 b 型转向磷酸化的 a 型，通常更偏向活性构象；肌型磷酸化酶 b 仍可被腺苷一磷酸（adenosine monophosphate，AMP）显著激活。a／b 命名因此表示共价状态与构象偏好，不等于跨组织通用的“全开／全关”。[^enzyme-regulation]

蛋白质磷酸酶 1（protein phosphatase 1，PP1）在糖原靶向亚基帮助下去磷酸化两条相向支路：它通常使糖原合酶趋于活化，同时使磷酸化酶和磷酸化酶激酶趋于失活。胰岛素信号还可经蛋白激酶 B（protein kinase B，AKT）抑制 GSK3，并支持糖原合酶去磷酸化；胰高血糖素或肾上腺素引起的环腺苷一磷酸（cyclic adenosine monophosphate，cAMP）—PKA 信号则促进磷酸化酶激酶和糖原磷酸化酶活化，同时抑制糖原合酶。这样的互补调节降低大规模底物循环，却不要求合成和分解在每个颗粒、每一时刻绝不并存。[^pp1-insulin]

### 肝与骨骼肌的组织特异性调节 { #tissue-specific-regulation }
...
收缩引起的 Ca$^{2+}$ 信号与 AMP 升高能在激素变化之前迅速动员肌糖原。肝细胞则把葡萄糖本身、胰岛激素和神经内分泌信号汇合起来。“胰岛素促进合成、胰高血糖素促进分解”概括全身调节方向；组织内响应还由颗粒定位、PP1 靶向亚基、酶同工型、训练与营养状态共同决定。运动时各供能系统的相对贡献见[肌细胞生理](../physiology/muscle.md)，胰岛激素的分泌控制见[胰岛内分泌](../physiology/endo/endo_islet.md)。

## 肝糖原补充的直接与间接途径 { #direct-indirect-pathways }
...
两条路径的相对贡献随膳食组成、肝葡萄糖摄取、激素背景、物种和测量方案改变。间接路径的三碳前体可来自肠道、肝内糖酵解和多种外周组织，其贡献随膳食及示踪条件变化。

## 糖原贮积病的区室与组织定位 { #glycogen-storage-diseases }

糖原贮积病（glycogen storage disease，GSD）包含合成、胞质分解、溶酶体降解、糖酵解和葡萄糖输出等不同缺陷，可表现为糖原减少、积累或结构异常。现行定位应同时注明基因、区室、组织和受阻反应；罗马数字编号仍保留历史沿革中的差异。[^gsd-overview]
...
肝糖原合酶缺陷通常归为 0 型，多种磷酸化酶激酶缺陷归入 IX 型谱系。VII 型 Tarui 病由肌磷酸果糖激酶 *PFKM* 缺陷导致，历史上虽纳入 GSD，却直接阻断糖酵解而非糖原末端切除，机制见[糖酵解](emp.md#nonequilibrium-control)。疾病表现、诊断和治疗须在[糖与能量代谢紊乱](../physiology/pathophysiology/metabolic_disorders.md)中结合临床证据讨论；代谢反应定位不能替代个体化临床判断。[^gsd-classification]
