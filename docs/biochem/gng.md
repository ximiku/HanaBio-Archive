...
糖异生是以乳酸、甘油和生糖氨基酸等非糖前体合成葡萄糖的过程。它不是把[糖酵解](emp.md)的十步反应逐一倒放：七个接近平衡的反应可以共用酶，己糖激酶／葡糖激酶、磷酸果糖激酶-1（PFK-1）和丙酮酸激酶所催化的三个远离平衡步骤，则由四种糖异生酶分三段绕行。每段旁路都要付出能量或水解磷酸酯，因而使净合成在热力学上可行。[^gluconeogenesis-overview]

在哺乳动物中，糖异生首先维持禁食期的血糖供应，使成熟红细胞等高度依赖葡萄糖的组织仍有底物可用；它也把不同器官输出的乳酸、甘油和含氮碳骨架重新纳入全身代谢。这个过程与[糖原合成与分解](glycogen.md)在时间上重叠：餐后血糖主要来自吸收，短期禁食先有较多肝糖原分解，禁食延长后糖异生的相对贡献上升，不能用一个固定时点把两条通路截然分开。

## 肝与肾把局部碳流转成血糖输出 { #organs-and-purpose }

肝脏是餐后吸收结束后维持血糖的主要器官，肾皮质近端小管也能进行完整糖异生；随禁食延长或酸负荷增加，肾脏贡献可以上升。小肠在特定营养和禁食状态下可能表达完整酶系，但其定量贡献依物种、实验方法和生理条件而变。因而“糖异生主要发生在肝”是合适的起点，却不等于肝是唯一场所。[^organ-contribution]

许多细胞能够从乳酸或氨基酸生成丙酮酸、草酰乙酸、磷酸烯醇式丙酮酸（PEP），甚至葡萄糖-6-磷酸（G6P），但这不等于它们都能向血液释放游离葡萄糖。骨骼肌缺少足以完成血糖输出的葡萄糖-6-磷酸酶系统；肌糖原产生的 G6P 因而留在肌细胞中供糖酵解或其他支路使用。判断一个组织是否“进行糖异生”，需要区分局部合成中间物、合成 G6P 与完成净葡萄糖输出三个层次。

## 前体从不同节点进入共同主干 { #precursor-entry }

糖异生前体的共同特征不是“不含糖”，而是其碳能进入丙酮酸、三羧酸循环中间物或丙糖磷酸，并在扣除脱羧损失后形成葡萄糖的净碳流。不同前体从不同节点进入，所需的区室转运、还原力和脱氮步骤也不同。
...
| 甘油 | 甘油激酶生成甘油-3-磷酸，再氧化成二羟丙酮磷酸（DHAP） | 三酰甘油的甘油骨架能够生糖，不应与脂肪酸的乙酰-CoA混为一谈 |
...
## 三段旁路跨越糖酵解的热力学边界 { #three-bypasses }

### 丙酮酸先羧化，再脱羧磷酸化 { #pyruvate-to-pep }
...
PC 以共价结合在赖氨酸上的生物素搬运活化的 CO$_2$，并以乙酰-CoA为必需的变构激活剂。这个反应既是糖异生入口，也是补充三羧酸循环中间物的填补反应；原材料所写的“ATP＋CO$_2$＋PEP生成草酰乙酸”把底物误成了 PEP，也倒置了这一碳流。[^pyruvate-carboxylase]
...
先加上的羧基在这一步离去；脱羧与磷酸化耦联，帮助生成高磷酰基转移势的 PEP。反应产物没有额外的 P$_i$。人类有胞质 PCK1 和线粒体 PCK2，二者都能催化上述化学反应，但相对通量随组织和代谢状态改变，不能用“某类动物只有线粒体型、另一类只有胞质型”概括。[^pepck-isoforms]

### 果糖-1,6-二磷酸酶与 PFK-1 相向调节 { #fbpase-bypass }
...
### 内质网葡萄糖-6-磷酸酶完成输出 { #g6pase-bypass }
...
## 草酰乙酸运输同时安排胞质还原力 { #compartment-and-redox }
...
以乳酸为起点时，胞质乳酸脱氢酶已经在乳酸变丙酮酸时生成 NADH，因此不必依靠苹果酸输出提供全部还原力；以丙氨酸为起点时，转氨反应不生成 NADH，碳与还原当量的跨膜安排便更重要。把苹果酸路径只画成“草酰乙酸出不了膜的替代运输”，会漏掉它对胞质 NADH／NAD$^+$ 的影响。天冬氨酸路径还把碳流与氨基转移联系起来，不能假定每种底物都沿同一条固定穿梭。

## 合成一分子葡萄糖消耗六个高能磷酸键 { #energy-accounting }
...
不同前体的局部账本还会改变。两分子乳酸氧化成丙酮酸时同时生成两分子胞质 NADH，恰好抵偿主干所需；甘油从 DHAP进入，绕过 PC、PEPCK及部分耗能步骤；氨基酸则还要计算脱氮和尿素合成。因而“每分子葡萄糖一律消耗 6 ATP”不够准确：严格说是从两分子丙酮酸出发消耗四个 ATP与两个 GTP。

## 变构、共价修饰与转录共同分配通量 { #regulation }

糖异生没有一个跨组织、跨状态永远独占控制权的“唯一限速酶”。底物到达、线粒体 ATP和 NADH供应、PC／PEPCK旁路、FBPase-1、G6Pase系统以及产物输出都可能分担控制；测到某一种酶的表达量升高，也不能单独证明整条通路的净通量升高。[^distributed-control]
...
| 柠檬酸升高 | 可激活 FBPase-1并抑制 PFK-1 | 连接线粒体碳供应充足与胞质六碳糖合成，但不是单独的开关 |
...
肝脏 PFK-2／FBPase-2 双功能蛋白在 PKA 磷酸化后偏向降解 F2,6BP，使 PFK-1活性降低、FBPase-1抑制解除；进食与胰岛素相关的去磷酸化通常产生相反结果。心脏等组织使用的同工型调节方向可以不同，不能把肝脏规则推广到所有细胞。PCK1、FBP1和 G6PC的表达还受 CREB、FOXO、糖皮质激素受体、PGC-1 共激活因子等网络影响，时间尺度比变构调节和磷酸化更慢，具体胰岛激素背景见[胰岛内分泌](../physiology/endo/endo_islet.md)。[^hormonal-regulation]

相向反应通常被互补调节，却不会在活细胞中完全降为零。PFK-1／FBPase-1或丙酮酸激酶／PC—PEPCK之间若保留有限的双向周转，称为底物循环：它消耗高能磷酸键，能提高净通量对调节信号的敏感性，并把部分能量散为热。只有在两向通量都很高而缺乏生理收益时才适合称为严重的“徒劳循环”，不能把整个“葡萄糖—丙酮酸—葡萄糖”笼统视作单一循环。

## 器官间循环转移碳、能量与氮 { #interorgan-cycles }

在 Cori 循环中，成熟红细胞和高糖酵解组织释放乳酸，肝脏以及一定条件下的肾脏摄取乳酸并重新合成葡萄糖。外周糖酵解每分子葡萄糖净得 2 ATP，而从两分子乳酸重建葡萄糖的产糖器官要消耗六个高能磷酸键，所以全身合计净消耗四个 ATP当量。这个循环把快速、无需线粒体的 ATP供应与乳酸清除交给外周组织，再把能量负担移到能氧化脂肪酸的器官；它转移能量负担，并不凭空创造能量。[^cori-cycle]

葡萄糖—丙氨酸循环还转移氮。骨骼肌把氨基转给丙酮酸形成丙氨酸，肝脏取回其碳骨架用于糖异生，并把氮导向尿素循环。肝脏因此同时承担合成葡萄糖和处置氮的能量成本。丙氨酸只是多种器官间氮载体之一，禁食时的蛋白质分解也不应被误写成无限持续的“供糖方案”；氨基酸碳骨架的差异见[蛋白质降解与氨基酸分解代谢](pr_aa_catabolism.md)。[^alanine-cycle]

## 肾糖异生与酸碱调节共享谷氨酰胺碳流 { #renal-acid-base }
...
这里不能简化为“糖异生反应直接把 H$^+$ 排进尿液”。铵生成、尿液缓冲与排泄、$\alpha$-酮酸代谢和碳酸氢盐回补彼此耦联，实际贡献还受肾功能、酸碱状态与可用底物影响。乳酸和甘油同样能成为肾糖异生底物，却不以与谷氨酰胺相同的方式增加铵生成。

## 遗传缺陷揭示终末旁路的生理边界 { #clinical-boundaries }
...
这些疾病不能用“缺一个限速酶，所以整条代谢为零”解释：残余活性、组织分布、底物旁路和治疗状态都会改变表现。这里的病例用于显示各旁路为何不可由糖酵解酶简单逆转，不构成诊断或饮食建议。
