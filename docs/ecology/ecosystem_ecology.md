...
**生态系统**（ecosystem）把生物群落与其物理、化学环境放在同一研究边界内。森林包括乔木、鸟和微生物，也包括土壤水分、矿质元素、枯落物、辐射以及跨边界输入输出；湖泊同样由水中生物、物理环境和物质通量共同构成。Tansley 提出这一术语时，强调的正是生物与环境共同构成的物理系统。[^tansley-ecosystem]

生态系统的组成与边界是分析起点，生产者—消费者—碎屑途径把它连接到食物链、食物网、营养级、生态金字塔、能量收支、传递效率、污染物放大以及上下行控制。初级与次级生产的测定、分解速率和完整能流预算见[生产力、分解与能量流](production_decomposition.md)，元素的库与循环见[生物地球化学循环](biogeochemical_cycles.md)。

## 生态系统的边界、组分和过程 { #ecosystem-boundaries }
...
生态系统分析常把对象分成**库**（stock）与**通量**（flux）。某时刻土壤有机碳、湖水溶解磷和植物生物量是库，单位可写成质量或能量每单位面积；光合固定、摄食、呼吸、淋溶和迁出是单位时间内改变库的通量。单位和边界一致时，库的增加、减少或近似稳态才可由各项通量解释。

物质可在生物、碎屑和无机环境之间反复转化，能量则以辐射或化学能进入，经生物化学反应和食物关系传递，最终以热耗散。动物信号、植物挥发物、病原体诱导和行为记忆也会改变过程速率，这类“信息交流”指影响相互作用的结构和信号，具有不同于能量或元素守恒通量的分析方式。

生产、分解、养分再生和食物网传递是常用的生态系统过程。组成、气候或外来输入改变时，库和通量会随之重组。所谓调节力失效，可能表现为负反馈减弱、正反馈增强、关键功能组丧失或外界压力越过阈值，这些过程比抽象的“信息系统破坏”更便于测量。

## 非生物环境与功能组 { #ecosystem-components }
...
| 功能组 | 主要过程 | 典型成员与边界 |
| --- | --- | --- |
| **生产者**（producer） | 以光能或无机化学反应提供的能量固定无机碳，形成有机物 | 绿色植物、藻类、蓝细菌和其他光合细菌，以及化能无机自养的细菌和古菌；它们把外来能量转成可进入生物量的化学能 |
| **消费者**（consumer） | 摄取其他生物或其产物，进行异养生长、维持和繁殖 | 植食者、捕食者、杂食者、寄生物与滤食者；消费者改变生产者、猎物、竞争关系和养分再生 |
| **微生物分解者**（microbial decomposer） | 通过胞外酶把大分子有机物转成可吸收的小分子，并使部分元素矿化 | 细菌、真菌和部分古菌；它们承担许多化学分解和养分再生过程 |
| **食碎屑者**（detritivore）与**食腐者**（scavenger） | 摄食、破碎或搬运死亡有机物，扩大微生物作用界面并把碎屑能量带入动物食物网 | 蚯蚓、白蚁、螨、许多甲壳类、蠕虫和软体动物属于食碎屑者；秃鹫、蟹等可为食腐者。按消化位置和过程将其与微生物分解者分开，更便于追踪能流 |

同一生物可以跨组。食虫植物能光合也摄取动物来源的矿质营养，珊瑚与共生藻共同跨越自养和异养途径，许多原生生物兼有光合与吞噬能力。功能组用于追踪过程，不构成新的分类阶元。

**初级生产**（primary production）是自养生物形成有机物的过程；**次级生产**（secondary production）是异养生物把已摄取或吸收的有机物转成自身新生物量的过程，包括个体生长和繁殖产生的组织。生产量是在给定时间内形成的量，生产力是单位面积或体积、单位时间的速率。次级生产以新增生物量或能量计量，与消费者呼吸及单独记录的后代数量采用不同口径。
...
图中的实线追踪物质与可利用化学能进入各库的主要路径，虚线表示能量经呼吸等过程耗散。排遗、死亡和未被摄食的生产把各营养层都连接到碎屑库，碎屑链因而成为食物网的核心能量通道。[^detrital-web]

## 食物链与食物网 { #food-chains-webs }

**食物链**（food chain）按资源被摄食的先后排列一条能量和物质路径，例如草—蝗虫—蛙—蛇。自然群落中，一个消费者常取食多个资源，一个资源也被多个消费者利用，死亡物和排泄物再进入微生物与食碎屑者通道，多条链因而交织成**食物网**（food web）。记录“谁吃谁”得到拓扑食物网；加入摄食量、生产量或作用强度后，还可判断各条联系承担的通量和控制作用。

箭头方向需要事先声明。图中按能量和物质传递方向，由资源指向消费者；若研究的是种间作用，消费者对资源的负效应箭头则方向相反。同一张图混用两套箭头会使食物网和调控网难以区分。
...
水体中的**微生物环**（microbial loop）把溶解有机碳带入细菌，再经异养原生生物和浮游动物返回较大的消费者。陆地枯落物也同时进入真菌主导和细菌主导的通道。快周转的牧食通道与较慢的碎屑通道可以在共同捕食者处耦合，通道间时间尺度差异有时会缓冲波动。[^food-web-channels]

寄生链是食物网的一类路径：寄生物以寄主组织或资源为食，重寄生物又利用寄生物，寄生关系可显著增加网络连接。曾称“腐生链”的部分可归入微生物分解和碎屑通道。寄生者、病原体和共生微生物体型小、生活史隐蔽，早期食物网常低估其连接数。

## 营养级与连续营养位置 { #trophic-levels }

**营养级**（trophic level，TL）把从基础资源到消费者的摄食步数相近者归在一起。生产者通常置于第 1 营养级，直接利用生产者的初级消费者位于第 2 级，捕食它们的消费者位于更高层。碎屑是碎屑食物网的基础资源，分解者和食碎屑者还会被原生生物、无脊椎动物和脊椎动物继续摄食，因此其位置由具体摄食路径决定。
...
食物链长度可用最长摄食路径、最高营养位置或能量传递次数表示，三种定义可能给出不同数值。许多生态系统常见少于约五个主要营养级，这来自每次传递的损失、种群维持所需资源和网络动力学共同约束；生态系统面积、资源供应、干扰、捕食关系和组装历史都会改变链长。[^food-chain-length]

## 生态金字塔的测量对象 { #ecological-pyramids }

**生态金字塔**（ecological pyramid）把各营养级的数量、现存生物量或一定时间内的生产和能流并列。三者单位不同，各自的形状需要按相应测量量解释。
...
## 个体能量预算与营养级效率 { #energy-budget-efficiency }
...
有些简化预算把 $U$ 合并进代谢损失，写成 $P=A-R$；采用哪一口径必须注明。对生产者，光合作用固定的总量记为**总初级生产**（gross primary production，GPP），扣除自养呼吸后得到**净初级生产**（net primary production，NPP）。具体测定方法见[生产力、分解与能量流](production_decomposition.md)。

生态效率描述预算中不同节点的比例。设第 $n$ 营养级的生产为 $P_n$，第 $n+1$ 级从它摄食 $I_{n+1}$、同化 $A_{n+1}$、形成生产 $P_{n+1}$，则：

| 效率 | 公式 | 生物学含义 |
| --- | --- | --- |
| **消费效率**（consumption efficiency，CE） | $CE=I_{n+1}/P_n$ | 下层新生产中有多少被上层实际摄食；未摄食部分可死亡、储存或进入碎屑链 |
| **同化效率**（assimilation efficiency，AE） | $AE=A_{n+1}/I_{n+1}$ | 摄入能量中有多少穿过消化或吸收界面；受食物化学组成、结构、防御和消化生理影响 |
| **净生产效率**（net production efficiency，PE） | $PE=P_{n+1}/A_{n+1}$ | 已同化能量中有多少形成新的消费者生物量，余量用于呼吸、活动和其他损失 |
| **营养级传递效率**（trophic transfer efficiency，TTE） | $TTE=P_{n+1}/P_n$ | 相邻两营养级生产率之比；在上述口径下 $TTE=CE\times AE\times PE$ |

“生态效率”“Lindeman 效率”和“传递效率”在不同文献中可能分别指生产比、摄食比或同化比，因此应同时报告公式。这里以 $CE=I_{n+1}/P_n$ 表示消费效率，以相邻营养级生产率之比表示总传递效率；$A_{n+1}/A_n$ 是同化量之比，与上述三项效率乘积采用不同口径。

食肉动物的同化效率常高于食草动物，主要因为动物组织较易消化，而植物细胞壁和化学防御会降低吸收，具体排序仍随物种与食物而变。内温动物把大量同化能用于维持体温，群体净生产效率通常低于外温动物；同化效率本身主要受食物与消化影响。幼体在快速生长期可能有较高生产效率，成年个体的繁殖投入也属于生产，应与体重增加共同计量。

植物把太阳辐射转成生物量的效率与消费者把同化有机物转成新组织的效率具有不同分母，需要分别比较。跨类群比较还会受到体型、温度、食物质量、化学计量和维持代谢影响。

### 十分之一法则的用途和限度 { #ten-percent-rule }

Lindeman 的营养动力学把各营养级的生产和能量损失放进统一预算，并使“相邻营养级约传递十分之一”成为经典教学近似。[^lindeman] 它适合说明能量为何沿链逐级减少，也可用于数量级估算；真实食物链的效率围绕广泛范围变化。
...
## 污染物的个体积累与食物网增浓 { #contaminant-transfer }

能量逐级减少时，不同物质的浓度响应由其摄入、代谢与排出性质决定。难降解、易被组织结合且排出缓慢的污染物可以在个体内积累，并随食物关系转移。三个相近术语应按路径区分：
...
生物浓缩的判据是只考虑环境介质的直接吸收，而“同营养级从环境蓄积”还可能包含食物等途径，属于更宽的生物积累。美国 EPA 也按直接水相摄取、全部途径摄取和跨营养级升高区分三者。[^bioaccumulation]
...
## 上行供给与下行控制 { #bottom-up-top-down }

底层资源供应向上传递的作用称**上行控制**（bottom-up control）。光、氮、磷、水分或碎屑输入增加，可能先提高生产者或微生物生产，再改变植食者和捕食者；响应能否向上传递受食物质量、消费者饱和和栖息地结构限制。**下行控制**（top-down control）从消费者开始：捕食者改变猎物数量或行为，间接影响更低营养级，连续的间接效应称**营养级联**（trophic cascade）。
...
## 系统开放性与反馈 { #feedback-openness }

自然生态系统通常是**开放系统**（open system），持续交换能量、物质和生物。河流接受上游有机质并向下游输出，森林与大气交换碳和水，海岛依靠迁入补充物种。分析遗漏这些跨界通量时，局地消费者的能量需求可能看似超过本地生产。

热力学中的**封闭系统**（closed system）不交换物质但可以交换能量，**孤立系统**（isolated system）既不交换物质也不交换能量。“宇宙舱生态系统”或密闭微宇宙努力使物质循环闭合，同时仍从外界接受光或电并释放热；完全封闭且长期自持的生命系统在实践中难以实现。开放与封闭描述边界交换，系统稳定性则需另用状态与时间尺度衡量。

反馈把状态变化送回过程速率。资源减少使消费者增长放慢、密度升高使死亡或迁出增加，属于可能抑制偏离的**负反馈**（negative feedback）；捕食者—猎物时滞可让同一反馈产生振荡。植被丧失引起侵蚀和保水下降、浑水抑制水草而水草丧失又维持浑水，则可形成放大变化的**正反馈**（positive feedback）和替代稳态。负反馈有助于局部稳定，群落能否回到原状态还取决于反馈强度、时滞和吸引域。

物种丧失对稳定性的影响取决于身份、功能冗余、响应差异和食物网位置。长期草地实验显示较高植物多样性可提高群落生产的时间稳定性，部分来自物种波动不同步；关键捕食者或主要分解者的丧失又可能产生不成比例的后果。[^biodiversity-stability] 随机连接的复杂模型中，复杂度可能降低稳定性；真实食物网的相互作用强度、模块、快慢能量通道和反馈符号同样重要。[^complexity-stability]

单个物种灭绝的影响需沿具体网络位置与功能评估。稳定性还必须说明测量的是生产变异、物种持续、受扰幅度、恢复速度还是状态转换阈值。

## 食物网的通量与机制推断 { #food-web-inference }

一张物种连线图回答谁可能吃谁，营养级回答资源路径长度，能量预算回答多少生产真正传到上层，操纵实验回答某个节点是否控制其他节点。连线数和通量需要分别测量；数量稀少的关键种也可能通过强相互作用改变整个网络，频繁发生但彼此补偿的联系则可使总功能较稳定。
