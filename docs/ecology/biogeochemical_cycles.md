...
生态系统中的碳、氮、磷和硫不断在生物体、空气、水、土壤、沉积物与岩石之间转移。生物通过同化、摄食、排泄和分解改变元素形态，地球化学过程又通过风化、溶解、沉淀、扩散和构造运动连接局地生态系统与整颗行星。**生物地球化学循环**（biogeochemical cycle）就是大小和周转速度各异的元素库由通量连接成的网络。

[生产力、分解与能量流](production_decomposition.md)说明有机物怎样形成、被利用并分解；元素循环继续追踪分解释放的元素怎样重新进入生物圈。水循环提供输送介质，碳循环连接能量代谢和气候，氮、磷、硫循环则突出微生物转化、营养限制和氧化还原反应。各种循环在人类扰动下的共同变化，见[生物群系与全球变化](biomes_global_change.md)。

## 库、通量与周转时间 { #pools-fluxes-turnover }

**库**（pool 或 reservoir）是在规定边界内以某种形态储存的物质量，例如大气中的 N₂、海水中的溶解无机碳、植被中的有机碳或沉积物中的磷。库容大、滞留久且多为非生物的部分常称“储存库”，库容较小、交换较快且常含生物组分的部分常称“流通库”。同一个库内部仍可能包含快慢组分：表层土壤有机质可在季节尺度周转，矿物结合有机质则可保存很久；海洋表层与深海也需分别描述。
...
大气水汽可以在日到周尺度更新，深层地下水和冰盖却可保存极久；生物体内无机氮可能数小时至数日被利用，大气 N₂ 与沉积氮则处在完全不同的时间尺度。周转时间由所选库、化学形态、边界和过程决定，无法仅按元素名称作全球排序。

## 水循环中的能量与物质输送 { #water-cycle }

太阳辐射为蒸发和蒸腾提供能量，重力驱动降水、坡面径流、河流和地下水向低处移动。海洋蒸发的水汽一部分在海上凝结降回海洋，陆地蒸散的水汽也可在陆地再次降水，分别称为海洋小循环与陆地小循环；海洋水汽输送到陆地、形成降水，再由河流和地下水返回海洋，则构成海陆大循环。这些名称按水汽来源和降水去向划分同一全球网络中的通量。
...
海洋容纳地球上绝大部分水，冰盖和地下水也形成巨大储库；大气、河流和生物体内的水量小，却因周转快而对天气、溶质运输和生物代谢格外重要。在一个生态研究期内，大部分水停留在海洋、深层地下水或冰体等大库中，只有一部分进入快速的蒸散—降水—径流支路；深海环流、冰川流动和水岩反应则在更长尺度上交换水。

水还搬运其他元素。风化产生的离子随径流进入河海，溶解有机碳和颗粒有机质沿坡面与河网横向输送，地下水则可把硝酸盐、硫酸盐或还原性溶质带到湿地和近岸。筑坝、灌溉、排水、城市不透水面和地下水开采同时改变水量，以及物质到达生物可利用位置的时间与路径。

## 生物代谢与岩石圈碳循环 { #carbon-cycle }

碳库的大小排序取决于边界。若包括沉积岩、变质岩和地幔中的碳，岩石圈是最大的长期储库；若讨论近地表、能够在较短地质时期与大气交换的活跃碳库，海洋中的溶解无机碳远大于大气和陆地植被。[^carbon-cycle-reservoirs]
...
海洋表面通过分压差与大气双向交换 CO₂。**溶解度泵**（solubility pump）借助冷水吸收、海水环流和深层混合搬运溶解无机碳；**生物泵**（biological pump）则由浮游生物固定碳，随后以颗粒沉降、溶解有机物输送和食物网迁移把一部分碳带离表层。钙化生物形成 CaCO₃，碳酸盐颗粒沉降并最终埋藏；碳酸盐风化、沉积、俯冲和火山逸气又把这一支路接入慢速地质循环。地质慢循环可持续数百万年以上，与一年尺度的森林净吸收需要分别比较。[^nasa-carbon-cycle]

碱性、富含 Ca²⁺ 和 HCO₃⁻ 的水体中，一些轮藻和沉水被子植物利用 HCO₃⁻ 光合作用，使叶表微环境 pH 升高并促进 CaCO₃ 沉淀，外观上像植物“释放碳酸钙”。沉淀实际来自水体离子在光合改变的化学条件下结晶，且只发生于相应物种和环境。钙化同时改变溶解无机碳与总碱度，在某些条件下还可促进 CO₂ 释放；净碳封存还需计入这些完整通量。[^charophyte-calcification]

**源**（source）和**汇**（sink）描述给定边界与时期内的净通量。一个森林在生长年份可为大气 CO₂ 净汇，火灾年份可转为净源；海洋长期净吸收人为 CO₂ 时，局部上升流区仍可向大气释放 CO₂。汇的持续时间还取决于后续释放与储存过程。20 世纪碳预算研究曾把估算排放与大气增量之间未能归因的差额称为**缺失碳汇**（missing sink）。今天的全球碳预算分别估计化石燃料与土地利用排放、大气增长、陆地汇、海洋汇和预算不平衡；其中预算不平衡表示观测与模型估计之间的残差及其不确定性。[^global-carbon-budget]

## 氮循环的微生物通路 { #nitrogen-cycle }

大气 N₂ 是全球最大的可交换氮库，却因三键稳定而只能被固氮生物直接利用。固氮生物以固氮酶把 N₂ 还原成 NH₃，进入水后主要以 NH₄⁺ 存在。根瘤菌与豆科等植物共生，自生固氮细菌和古菌分布于土壤、沉积物和水体，蓝细菌则可依靠光能自养并固氮。共生固氮在陆地植物中十分醒目，自生固氮则同时存在于陆地和海洋。闪电能生成反应性氮，但全球自然新生反应性氮主要由生物固氮提供。工业 Haber–Bosch 合成氨和化石燃料燃烧又在人类时代大幅增加反应性氮输入。[^human-nitrogen-cycle]

生物把 NH₄⁺ 或 NO₃⁻ 同化进氨基酸、核苷酸等有机物。死亡、排泄和分解后，有机氮经胞外水解、脱氨及多种微生物反应矿化为 NH₄⁺，这一整体过程称**氨化**（ammonification）或氮矿化；蛋白质水解为氨基酸是其中的前段过程。在有氧环境，氨氧化细菌和古菌把 NH₃／NH₄⁺ 氧化为 NO₂⁻，亚硝酸盐氧化菌再生成 NO₃⁻；部分 *Nitrospira* 可在同一细胞中完成**全程氨氧化**（complete ammonia oxidation，comammox）。两步硝化与 comammox 构成由不同执行者完成的硝化路径。[^microbial-nitrogen-network]

低氧环境中，**反硝化**（denitrification）通常依次把 NO₃⁻ 还原为 NO₂⁻、NO、N₂O 和 N₂，使固定氮返回大气。许多反硝化者以有机碳为电子供体，也有利用 H₂、还原硫或亚铁等无机供体的自养反硝化者；参与者包括多个细菌和古菌类群。渍水土壤是经典场所，湖泊与海洋沉积物、湿地、污水、生物膜、土壤团聚体和海洋低氧区同样可发生。**厌氧氨氧化**（anaerobic ammonium oxidation，anammox）把 NH₄⁺ 与 NO₂⁻ 转成 N₂；**异化硝酸盐还原成铵**（dissimilatory nitrate reduction to ammonium，DNRA）则把 NO₃⁻ 留在可再利用的固定氮库。固氮、反硝化和厌氧氨氧化共同影响长期平衡，各地点和年份的输入与损失可暂时偏离。
...
饮水中的 NO₃⁻ 可在体内或受污染水体中还原成 NO₂⁻；亚硝酸盐把血红蛋白中的 Fe²⁺ 氧化为 Fe³⁺，形成携氧能力低的高铁血红蛋白。婴儿较易发生**高铁血红蛋白血症**（methemoglobinemia），严重时皮肤发绀，故有“蓝婴病”之称。风险由亚硝酸盐氧化血红蛋白的作用与胃肠道感染、井水微生物污染等条件共同决定。[^who-nitrate]

## 磷的风化、再生与沉积 { #phosphorus-cycle }

磷几乎没有主导全球通量的稳定气相，因而称为**沉积型循环**（sedimentary cycle）。含磷岩石和沉积物是最大的长期库：构造抬升使磷灰石等矿物暴露，物理侵蚀与化学风化释放溶解或颗粒态磷；植物、微生物和菌根吸收无机磷酸盐，食物网再把有机磷传递给消费者。死亡物和排泄物经磷酸酶水解与矿化释放磷酸盐，后者可再次被生物吸收，也可吸附到铁、铝氧化物和黏土表面，沉淀为钙磷矿物，或在解吸、溶解和还原条件改变时重新进入水相。

径流和侵蚀把陆地磷送入河流、湖泊与海洋，颗粒沉降和沉积物埋藏构成长时间尺度的去向。海洋磷返回陆地通常慢于入海过程，海鸟和洄游鱼类的生物搬运、人类捕捞，以及海相沉积物经构造抬升和风化重返陆地共同构成回路。长地质回路与生态系统内部的快速摄取—矿化因而并存。[^global-phosphorus-cycle]

动物磷排泄会随摄食量、食物 C∶N∶P、组织生长、体温和肾脏调节而变，呼吸也受活动和代谢率影响，两者在某些物种或情境下可能相关。磷在呼吸链中没有固定消耗比例，其周转时间和排泄率需根据摄食、组织需求与排泄过程测量。生态系统磷周转还受矿物吸附、风化、侵蚀和微生物再生控制。
...
缺氧环境中，硫酸盐还原微生物以 SO₄²⁻ 为电子受体，把有机物或 H₂ 等电子供体氧化，并产生 H₂S／HS⁻。还原硫可被有氧或光合硫氧化微生物重新氧化成单质硫或硫酸盐，也可与 Fe²⁺ 形成 FeS，进一步转化为黄铁矿等矿物并埋藏。煤与石油冶炼以及含硫燃料燃烧把地质库中的硫快速转为大气 SO₂，构成硫循环的人为扰动；SO₂ 氧化形成硫酸盐气溶胶与酸沉降，可改变空气质量、土壤酸度、水体化学和养分流失。

### 氧化还原条件与铁—硫—磷耦联 { #iron-sulfur-phosphorus-coupling }
...
这套过程可解释 FeS 形成与磷释放之间的联系。pH、硫酸盐供应、有机碳、铁矿物种类、再氧化、钙磷沉淀和水体交换都会改变净效应，FeS 形成也可能把硫和铁共同埋藏。明确氧化还原状态和具体矿物过程后，才能判断磷的固定或动员方向。

## 代谢与环境中的元素耦联 { #coupled-cycles }
...
驱动这些反应的关键酶系统在微生物中高度保守。固氮酶、氨单加氧酶、硝酸盐还原酶、硫酸盐还原与硫氧化系统把细胞尺度的电子传递连接到全球元素通量。现代分子生态学能够用功能基因、转录本和基因组识别潜在执行者；现场通量则需结合浓度梯度、培养实验、同位素示踪和质量平衡确定。[^microbial-engines]
...
## 循环图与可检验预算 { #biogeochemical-budget }

循环图中的箭头落实为可测通量后，才能构成质量平衡模型。首先划定空间边界和时间窗口，再列出各库的化学形态与单位；随后分别测量输入、输出、库量变化和内部转化。内部通量改变形态或库位置，河流输出、大气沉降、收获和深层埋藏则跨越研究边界。库量和通量需要分别测量，浓度很低的反应中间体也可能因快速周转承担重要通量。
...
库—通量—周转框架是理解五类循环的主干。现代微生物组学、传感器和地球系统模型扩展了能够观察的执行者与尺度，并为循环图中的箭头补上反应物、执行者、环境条件、量纲和证据边界；质量守恒与自然史观察仍为这些方法提供约束。
