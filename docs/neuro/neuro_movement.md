...
α 运动神经元支配梭外肌纤维，γ 运动神经元收缩肌梭内梭内肌纤维的两端。随意收缩时常出现 α—γ 协同激活：梭外肌缩短的同时，γ 驱动维持肌梭中央感受区的张力，使 Ia、II 传入仍能报告长度和变化。所谓“γ 环”因而是调节感觉增益的一部分，并非高位中枢必须绕行肌梭才能驱动 α 运动神经元的唯一通路。β 运动神经元可同时支配梭内和梭外肌纤维，在不同物种和肌群中的比例与作用不宜作为统一主线。[^alpha-gamma]

## 本体反馈调节长度、张力和关节阻抗 { #proprioceptive-feedback }

肌梭与梭外肌纤维并联，主要感受肌长及其变化；group Ia 初级末梢同时响应动态和静态牵拉，group II 次级末梢更偏向持续长度。Ia 传入可直接兴奋同名肌和协同肌的 α 运动神经元，并经抑制性中间神经元降低拮抗肌活动。快速腱反射利用了这条短支路，但自然运动中的牵张响应还包含多突触脊髓支路、脑干和皮层长潜伏期成分，其增益会随姿势稳定需求和动作意图变化。详细回路见[反射与神经回路](neuro_reflex.md#stretch-reflex-circuit)。

Golgi tendon organ 与肌腱胶原串联，group Ib 传入更直接反映主动收缩和外力共同造成的张力。经典离体模型强调 Ib 抑制同名肌运动神经元，现实行为中 Ib 中间神经元的符号和目标会随站立、步行相位与下行状态重配，因此腱器官不是只在危险张力下启动的“保险丝”。肌梭、腱器官、关节和皮肤输入共同估计肢体状态，并调节肌肉共同收缩形成的关节阻抗。局部反馈既能抵抗扰动，也能在需要柔顺接触时降低增益。[^proprioceptive-control]
...
步行等节律运动依赖可在缺少逐拍皮层命令时产生交替输出的 central pattern generator。哺乳动物证据支持节律生成与具体肌群模式由分布式脊髓中间神经元网络完成，而感觉反馈通过负重、关节位置和足底接触延长或切换相位；网状脊髓等下行输入则启动、停止并设置速度和方向。人类脊髓网络的细胞类型和组织方式不能从猫、鼠或七鳃鳗模型逐项照搬，因此“存在节律生成能力”比指定一个单独步行中枢更可靠。[^spinal-rhythm]
...
| 通路 | 核心连接 | 经典净效应与现行边界 |
| --- | --- | --- |
| 直接通路 | striatum D1 projection neuron 抑制 GPi／SNr | 减少特定输出通道的持续抑制，有利于被选动作；不能等同全脑统一的“启动键” |
| 间接通路 | striatum D2 projection neuron 抑制 GPe，经 subthalamic nucleus 增强 GPi／SNr 输出 | 有助于压制竞争动作和调节切换；运动开始时可与直接通路共同活跃 |
| 超直接通路 | cortex 直接兴奋 subthalamic nucleus，再兴奋 GPi／SNr | 提供较快而较广的制动或阈值调整，随后可由更选择性的通路重塑 |
...
按连接和功能可辨认 vestibulocerebellum、spinocerebellum 与 cerebrocerebellum 的偏重：绒球小结叶—前庭网络参与凝视和平衡，蚓部和中间区利用躯体状态调节姿势与正在进行的肢体动作，外侧半球经脑桥—齿状核—丘脑环路参与复杂动作准备和学习。这些区域相互作用，也与传统“古／旧／新小脑”的系统发育名称并不严格一一对应；外侧小脑仍可接收由皮层处理过的感觉和状态信息，不能说它完全不接受外周信息。[^cerebellar-zones]
...
lower motor neuron 或其轴突损伤会使相应运动单位出现弛缓性无力、萎缩、反射减弱和失神经活动。upper motor neuron system 损伤急性期也可低张力、低反射，随后才形成速度依赖性 spasticity、腱反射亢进、阵挛和伸性跖反射；这些体征来自皮质及脑干下行控制、感觉增益和脊髓内在性质的共同重组，不是皮质脊髓束单独“释放一个反射”。小脑损伤更常造成同侧辨距不良、分解运动、意向性震颤和共济失调而无初级瘫痪，还可出现眼震及音节时距、重音异常的 scanning dysarthria；基底神经节异常则突出运动贫乏、过多或时序与活力改变。定位逻辑见[神经系统传导通路](neuro_pathway.md#tract-localization)，疾病机制见[神经系统疾病](neuro_disease.md)。[^motor-lesions]
...
[^proprioceptive-control]: 肌梭、Golgi tendon organ 与任务依赖反馈对运动稳定性的作用，参见 Purves 等 [The Influence of Afferent Activity on Motor Behavior](https://www.ncbi.nlm.nih.gov/books/NBK11119/)；本文不沿用“肌梭阈值高而先兴奋、腱器官阈值低而后兴奋”的倒置概括。
...
[^basal-output]: striatum、GPe、GPi、subthalamic nucleus、SNr 和 SNc 的连接及输出去抑制，参见 NCBI Bookshelf [Neuroanatomy, Basal Ganglia](https://www.ncbi.nlm.nih.gov/books/NBK537141/)。
...
[^motor-lesions]: upper／lower motor neuron 体征及急性到慢性变化，参见 NCBI Bookshelf [Neuroanatomy, Upper Motor Neuron Signs](https://www.ncbi.nlm.nih.gov/books/NBK541082/) 与 [Neuroanatomy, Lower Motor Neuron Lesion](https://www.ncbi.nlm.nih.gov/books/NBK539814/)；病理诊断须结合病程和解剖分布。
